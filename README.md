...
I also acknowledge the open-source community and the technologies used in this project, including:
...
Every item given a second life is one less item unnecessarily sent to waste. add markdown to add in readme file like **SustainSpace** etc
