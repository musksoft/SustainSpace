...
---
Note: The structure above shows the main project folders and selected files. Additional supporting components, pages, and files  exist within each module.
...
Special thanks to our project supervisor, faculty members, and everyone who provided valuable guidance and (survey) feedback throughout the development of SustainSpace.

I also acknowledge the open-source community and the technologies used in this project, including React.js, Vite, Tailwind CSS, React Router, and Supabase.
...
Keeping Sustainablity in Mind 🍃 . Muskan Shaikh. All Rights Reserved
