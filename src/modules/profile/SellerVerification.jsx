...
export default function SellerVerification() {
  ...
  const loadVerificationInfo = async () => {
    ...
    try {
      ...
      console.error(
        "Seller verification load error:",
        err,
      );
          ...
          <div className="px-5 md:px-8 py-6">
            <div className="max-w-7xl mx-auto">
              ...
              <p className="text-sm text-gray-600 mt-2 max-w-2xl leading-relaxed">
                ...
                premium seller features and build trust
                with conscious consumers. Our process
                ensures authenticity and commitment to
        ...
        <div className="px-4 py-5 md:p-8">
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-6">
                ...
                <div className="bg-[#D9F0E0] rounded-xl p-5">
                  ...
                  <div className="space-y-3 text-xs text-[#456052] leading-relaxed">
                    ...
                    <p>
                      ...
                      Buyers love to see the artisan
                      behind the work.
                    </p>

                    <p>
                      Your documents are only used
                      for verification and are not
                      displayed publicly.
                    </p>
                  </div>
                </div>
              ...
              <section className="bg-white border border-[#E8E3DA] rounded-xl min-h-[650px] overflow-hidden">
                {/* MAIN HEADER */}
                  ...
                  <div className="p-5 md:p-10">
                    <div className="max-w-xl mx-auto text-center py-10">
                      ...
                      <p className="text-sm text-gray-500 mt-3 leading-relaxed">
                        Your seller verification has
                        been approved. Buyers can now
                        see your verified seller status.
                      </p>
                  ...
                  <div className="p-5 md:p-10">
                    <div className="max-w-xl mx-auto text-center py-10">
                      ...
                      <p className="text-sm text-gray-500 mt-3 leading-relaxed">
                        ...
                        was not approved. You may submit
                        another request using your
                        remaining verification attempt.
                      </p>
                      ...
                      <div className="max-w-3xl">
                        ...
                        <div className="flex gap-3 mt-5 bg-[#F6F5F1] border border-gray-100 rounded-lg p-4">
                          ...
                          <p className="text-xs text-gray-500 leading-relaxed">
                            ...
                            stored and used only for seller
                            verification. They will not be
                            displayed publicly on your seller
                            profile.
                          </p>
                        </div>
